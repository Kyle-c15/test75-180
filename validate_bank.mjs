...
console.log(JSON.stringify({ total, single, multiple, pages: pageCounts.size, minPageCount: Math.min(...pageCounts.values()), maxPageCount: Math.max(...pageCounts.values()), answerPositions: counts, duplicateStems: total - stems.size, errors: errors.length }, null, 2));
if (errors.length) {
